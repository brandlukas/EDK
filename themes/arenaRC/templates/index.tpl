...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{$kb_host}/themes/skullRC/jquery.js" />
...
{$page_headerlines}
	...
	<script type="text/javascript" src="{$kb_host}/themes/skullRC/jquery.js"></script>
	<script type="text/javascript" src="{$kb_host}/themes/skullRC/transify.js"></script>
	<script type="text/javascript" src="{$kb_host}/themes/skullRC/load.js"></script>
...
{$page_bodylines}
	...
	<div class="light-bg">
		...
		<div id="skull">
			...
			<div class="image">
				<a href="http://lukas.ramv.de/wp" target="_blank"><div id="lefteye"></div></a>
				<div id="righteye"></div>
				<img src="http://i.imgur.com/BI6i1.png"/>
			...
			<div class="links">
				<ul style="text-align:center;padding-left:0px;">
					{section name=item loop=$menu}
						<li style="display:block;text-transform:uppercase;font-size:14px;color:white;">
