...
<br />
<div class="block-header2">Datenschutz/Secrecy obligation</div>
(Quelle/Source: <a href="http://www.datenschutzbeauftragter-info.de">www.datenschutzbeauftragter-info.de</a>)
...
Further information can be found under <a href="http://www.google.com/analytics/terms/gb.html">http://www.google.com/analytics/terms/gb.html</a> (Google Analytics Terms of Service & Privacy).  Please note that on this website, Google Analytics code is supplemented by “gat._anonymizeIp();” to ensure an anonymized collection of IP addresses (so called IP-masking).
<!-- /about_finish -->